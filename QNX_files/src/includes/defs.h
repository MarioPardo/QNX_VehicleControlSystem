...
#define SYS_BRAKING_RESPONSETIME_MS 100
#define SYS_DRIVE_RESPONSETIME_MS 200
#define SYS_CLIENT_RESPONSETIME_MS 600
#define SYS_TELEMETRY_RESPONSETIME_MS 600
#define SYS_VEHICLE_SENDER_RESPONSETIME_MS 300

//critical times : how many MS since last check in such that we kill and restart process
#define SYS_BRAKING_CRITICALTIME_MS 1000
#define SYS_DRIVE_CRITICALTIME_MS 2000
#define SYS_CLIENT_CRITICALTIME_MS 3000
#define SYS_TELEMETRY_CRITICALTIME_MS 3000
#define SYS_VEHICLE_SENDER_CRITICALTIME_MS 3000
